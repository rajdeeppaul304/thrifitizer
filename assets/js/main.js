...
// Enhanced GSAP preloader animation with smoother transitions and scale effects
gsap.timeline()
	// Fade in preloader container
	...
	// Animate in first text with scale and blur
	.fromTo(".mil-animation-1 p",
		{ y: 40, opacity: 0, scale: 0.7, filter: "blur(8px)" },
		{ y: 0, opacity: 1, scale: 1, filter: "blur(0px)", stagger: 0.18, duration: 0.7, ease: "power3.out" }
	)
	// Add a pulse effect for the first text
	...
	// Reveal box wipe in
	.fromTo(".mil-reveal-box",
		{ x: 0, width: "0%" },
		{ width: "100%", x: 0, duration: 0.5, ease: "expo.inOut" }
	)
	// Quick snap to right
	.to(".mil-reveal-box", {
		right: 0,
	...
	// Animate in second text with scale and blur
	.fromTo(".mil-animation-2 p",
		{ opacity: 0, y: 40, scale: 0.7, filter: "blur(8px)" },
		{ opacity: 1, y: 0, scale: 1, filter: "blur(0px)", duration: 0.6, ease: "power3.out" }, "-=0.2"
	)
	// Pulse effect for second text
	...
	// Refresh ScrollTrigger and hide preloader
	.add(() => {
