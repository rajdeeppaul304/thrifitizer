      ...
      <section className="container py-5 my-5">
        <div className="row justify-content-center">
          <div className="col-lg-10">
                        <h1 className="mb-4 text-center">Terms of service
</h1>

<p className="my-bold-class"><strong>OVERVIEW</strong></p>
            <p>
This website is operated by thriftizer-solutions. Throughout the site, the terms “we”, “us” and “our” refer to thriftizer-solutions. thriftizer-solutions offers this website, including all information, tools and Services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.
<br/><br/>
...
<br/><br/>
Our store is hosted on Shopify Inc. They provide us with the online e-commerce platform that allows us to sell our products and Services to you.              {/* (continue the full text exactly as provided above, preserving structure) */}
   <br/><br/>         </p>

            <p className="my-bold-class"><strong>SECTION 1 - ONLINE STORE TERMS</strong></p>
            <p>
...
<br/><br/>A breach or violation of any of the Terms will result in an immediate termination of your Services.            </p>

          <br/><br/>  <p className="my-bold-class"><strong>SECTION 2 - GENERAL CONDITIONS</strong></p>
            <p>
...
<br/><br/>The headings used in this agreement are included for convenience only and will not limit or otherwise affect these Terms.            </p>

          <br/><br/>  <p className="my-bold-class"><strong>SECTION 3 - ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION</strong></p>
            <p>
...
<br/><br/>This site may contain certain historical information. Historical information, necessarily, is not current and is provided for your reference only. We reserve the right to modify the contents of this site at any time, but we have no obligation to update any information on our site. You agree that it is your responsibility to monitor changes to our site.            </p>
              ...
              <br/><br/>  <p className="my-bold-class"><strong>SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES</strong></p>
<p>
  ...
  <br/><br/> <p className="my-bold-class"><strong>SECTION 5 - PRODUCTS OR SERVICES (if applicable)</strong></p>
<p>
Certain products or Services may be available exclusively online through the website. These products or Services may have limited quantities and are subject to return or exchange only according to our Refund Policy: [LINK TO REFUND POLICY]
  ...
  <br/><br/> 
<p className="my-bold-class"><strong>SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION</strong></p>
<p>
...
We reserve the right to refuse any order you place with us. We may, in our sole discretion, limit or cancel quantities purchased per person, per household or per order. These restrictions may include orders placed by or under the same customer account, the same credit card, and/or orders that use the same billing and/or shipping address. In the event that we make a change to or cancel an order, we may attempt to notify you by contacting the e‑mail and/or billing address/phone number provided at the time the order was made. We reserve the right to limit or prohibit orders that, in our sole judgment, appear to be placed by dealers, resellers or distributors.
    ...
    <br/><br/> For more details, please review our Refund Policy: [LINK TO REFUND POLICY]

</p>
  <br/><br/> 
<p className="my-bold-class"><strong>SECTION 7 - OPTIONAL TOOLS</strong></p>
<p>
We may provide you with access to third-party tools over which we neither monitor nor have any control nor input.
  ...
  <br/><br/> 
<p className="my-bold-class"><strong>SECTION 8 - THIRD-PARTY LINKS</strong></p>
<p>
Certain content, products and Services available via our Service may include materials from third-parties.
  ...
  <br/><br/> 
<p className="my-bold-class"><strong>SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</strong></p>
<p>
  ...
  <br/><br/> 
<p className="my-bold-class"><strong>SECTION 10 - PERSONAL INFORMATION</strong></p>
<p>
...
<p className="my-bold-class"><strong>SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS</strong></p>
<p>
...
<p className="my-bold-class"><strong>SECTION 12 - PROHIBITED USES</strong></p>
<p>
...
(k) to interfere with or circumvent the security features of the Service or any related website, other websites, or the Internet. We reserve the right to terminate your use of the Service or any related website for violating any of the prohibited uses.
  ...
  <br/><br/> 
<p className="my-bold-class"><strong>SECTION 13 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</strong></p>
<p>
...
The obligations and liabilities of the parties incurred prior to the termination date shall survive the termination of this agreement for all purposes.
  ...
  <br/><br/> 
<p className="my-bold-class"><strong>SECTION 17 - ENTIRE AGREEMENT</strong></p>
<p>
The failure of us to exercise or enforce any right or provision of these Terms of Service shall not constitute a waiver of such right or provision.
  ...
  <br/><br/> 
<p className="my-bold-class"><strong>SECTION 18 - GOVERNING LAW</strong></p>
<p>
    These Terms of Service and any separate agreements whereby we provide you Services shall be governed by and construed in accordance with the laws of India.

</p>

  <br/><br/> <p className="my-bold-class"><strong>SECTION 19 - CHANGES TO TERMS OF SERVICE</strong></p>
<p>
    ...
    <br/><br/> We reserve the right, at our sole discretion, to update, change or replace any part of these Terms of Service by posting updates and changes to our website. It is your responsibility to check our website periodically for changes. Your continued use of or access to our website or the Service following the posting of any changes to these Terms of Service constitutes acceptance of those changes.
          ...
          <br/><br/>  <p className="my-bold-class"><strong>SECTION 20 - CONTACT INFORMATION</strong></p>
            <p>
              Questions about the Terms of Service should be sent to us at praveen@thriftizer.com. <br />
              Our contact information is posted below: <br />
              [INSERT TRADING NAME] <br />
              praveen@thriftizer.com <br />
