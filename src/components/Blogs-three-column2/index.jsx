                ...
                <div className="item">
                  <div className="bimg">
                    <div
                      ...
                      style={{ backgroundImage: "url(/blog/google.png)" }}
                    ></div>
                  </div>
                    ...
                    <div className="full-width">
                      ...
                      <h6 className="custom-font">
                        <Link href="/blog-details/blog-details-dark">
                          Google Algorithm Updates: All Major Changes in 2025.
                        </Link>
                      </h6>
              ...
              <div className="item-box">
                <div className="item">
                  <div className="bimg">
                    <div
                      className="img bg-img"
                      style={{ backgroundImage: "url(/blog/sge.png)" }}
                    ></div>
                  </div>
                  <div className="cont valign">
                    <div className="full-width">
                      ...
                      <h6 className="custom-font">
                        <Link href="/blog-details/blog-details-dark">
                          How to Optimize for Search Generative Experience (SGE).
                        </Link>
                      </h6>
                      <div className="btn-more custom-font">
                        <Link href="/blog-details/blog-details-dark">
              ...
              <div className="item-box">
                <div className="item">
                  <div className="bimg">
                    <div
                      className="img bg-img"
                      style={{ backgroundImage: "url(/blog/ai.png)" }}
                    ></div>
                  </div>
                  <div className="cont valign">
                    <div className="full-width">
              ...
              <div className="item-box">
                <div className="item">
                  <div className="bimg">
                    <div
                      className="img bg-img"
                      style={{ backgroundImage: "url(/blog/googleindex.png)" }}
                    ></div>
                  </div>
                  <div className="cont valign">
                    <div className="full-width">
